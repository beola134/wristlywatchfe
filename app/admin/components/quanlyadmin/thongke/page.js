...
export default function AdminStatistics() {
  ...
  useEffect(() => {
    const fetchRevenue = async () => {
      try {
        const response = await fetch(`https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalRevenueByTime?period=${period}`);
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTopProducts');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getAllOrdersWithUserDetails');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getNewUsersToday');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalProducts');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalUsersInWeek"
        );
        if (!response.ok) {
          throw new Error("Network response was not ok");
        }
   ...
   useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalThuonghieu');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalUsers');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalDonHang');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/thongke/getTotalRevenue');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
                    ...
                    <tr>
                      <td>
                        <div className={cx("user-info")}>
                          <img
                            src={`https://wristlywatchbe-bd4bdd62f0ed.herokuapp.com/images/${item.user.hinh_anh}`}
                            alt="User Image"
                          />
